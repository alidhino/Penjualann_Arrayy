...
for ($i = 0; $i < 5; $i++) {
    $index = array_rand($nama_barang);      // pilih index random
    $beli[] = $nama_barang[$index];         // simpan nama barang
    $jumlah[] = rand(1, 5);                 // jumlah random 1–5
    $total[] = 0;                           // nanti dihitung di commit 3
}
...
echo "--------------------------------<br>";
echo "<b>Total Belanja : " . $grandtotal . "</b>";
